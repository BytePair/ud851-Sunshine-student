...
class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
    ...
    private static final int FUTURE_VIEW_TYPE = 2;
    ...
    public ForecastAdapterViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        switch (viewType) {
            ...
            case FUTURE_VIEW_TYPE:
                resource = R.layout.forecast_list_item;
                break;
            // COMPLETED (14) Otherwise, throw an IllegalArgumentException
            default:
                throw new IllegalArgumentException("Could not find view");
        }
    ...
    public void onBindViewHolder(ForecastAdapterViewHolder forecastAdapterViewHolder, int position) {
        ...
        if (forecastAdapterViewHolder.getItemViewType() == TODAY_VIEW_TYPE) {
            weatherImageId = SunshineWeatherUtils
                    .getLargeArtResourceIdForWeatherCondition(weatherId);
        }

        // COMPLETED (16) If the view type of the layout is future day, display a small icon
        else if (forecastAdapterViewHolder.getItemViewType() == FUTURE_VIEW_TYPE) {
            weatherImageId = SunshineWeatherUtils
    ...
    public int getItemViewType(int position) {
        ...
        if (mUseTodayLayout && position == 0) return TODAY_VIEW_TYPE;
