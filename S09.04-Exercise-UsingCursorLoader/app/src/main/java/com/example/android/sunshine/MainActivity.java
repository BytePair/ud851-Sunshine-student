...
public class MainActivity extends AppCompatActivity implements
    ...
    private static final String[] desiredColumns = {
    ...
    public static final int INDEX_WEATHER_DATE_COL = 0;
    public static final int INDEX_WEATHER_ID_COL = 1;
    public static final int INDEX_WEATHER_MAX_TEMP_COL = 2;
    public static final int INDEX_WEATHER_MIN_TEMP_COL = 3;
